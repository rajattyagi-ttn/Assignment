...
import UIKit
 ...
 struct AccountMenu {
    ...
    public static var accountMenuItems : [[AccountMenu]] = [
        [AccountMenu(rowIcon: #imageLiteral(resourceName: "location"), rowName: "Location"),
        AccountMenu(rowIcon: #imageLiteral(resourceName: "sizeChart"), rowName: "Movies"),
        AccountMenu(rowIcon: UIImage(systemName: "bell")!, rowName: "Notifications"),
        AccountMenu(rowIcon: #imageLiteral(resourceName: "cross"), rowName: "My Circle / Employees"),],
        ...
        AccountMenu(rowIcon: #imageLiteral(resourceName: "Shipping"), rowName: "Change Theme"),]
